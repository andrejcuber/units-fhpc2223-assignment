...
echo "cores, sizeM, sizeN, sizeK, time[s],gflops" > blis_single_spread_epyc.csv 
echo "cores, sizeM, sizeN, sizeK, time[s],gflops" > blis_double_spread_epyc.csv 
...
do
	...
	./gemm_blis_double.x 9000 9000 9000 >> blis_double_spread_epyc.csv
done
